      ...
      <div className="m-4 shadow-xl sm:rounded-lg p-10">
        ...
        >
            ...
            <div className="col-span-12">
              ...
              <div className="col-span-12">
                {errors.property_amenities && touched.property_amenities && (
                  <p className="text-darkGold text-sm">
                        ...
                        index === values.property_floors.length - 1 && (
                          <div className="text-center mt-5">
                            <i
                              ...
                              className="fa fa-xmark cursor-pointer text-xl border-2 mb-5 text-darkGold border-red-500 py-1 px-3 rounded-full"
                              aria-hidden="true"
                            ></i>
                          </div>
                        )}
          ...
          {isLoading ? (
            ...
            <button
              type="submit"
              className="text-white bg-darkGold hover:bg-red-600 focus:outline-none font-medium rounded-lg text-sm px-8 py-2.5 text-center flex items-center gap-2"
            >
              {state === "add" ? (
                <>
