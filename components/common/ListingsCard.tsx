        ...
        <Card className="mx-4">
          ...
          >
            ...
            <div className="icons flex w-full justify-end gap-2">
              <i className="fa-solid w-full text-center md:w-fit fa-arrow-up-right-from-square text-white text-lg px-3 py-2 rounded-full bg-darkGold"></i>
              <i
                onClick={(e) => handleOpen("lg", e)}
                className="fa-solid hidden md:block fa-eye cursor-pointer text-white text-lg px-3 py-2 rounded-full bg-darkGold"
              ></i>
            </div>
          </CardFooter>
        </Card>
